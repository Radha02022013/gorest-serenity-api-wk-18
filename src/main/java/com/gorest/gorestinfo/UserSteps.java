...
import com.gorest.constatnts.EndPoints;
import com.gorest.constatnts.Path;
...
public class UserSteps {
    ...
    public ValidatableResponse createUser(String name, String email, String gender, String status) {
        ...
        return SerenityRest.given()
                ...
                .header("Authorization", "Bearer f9a71ebf5af377dd2a44ef795a6cf33262c3de4be88e60f6c004f83ed227fe98")
                .when()
                .post(Path.USERS)
                .then().log().all();
    }
